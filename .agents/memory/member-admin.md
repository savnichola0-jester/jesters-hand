...
- Hand roles are identity-pinned: active 00-00 or 01-54 plus the admin flag receives full normal admin authority, including account operations, archives, Reports, Investigations, contracts, admin cards, Deal, and SUITS. Self-targeting and permanent transfer/wipe of an admin account remain blocked.
