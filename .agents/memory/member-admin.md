...
- Hand roles are identity-pinned: 00-00 + admin flag is full admin; 01-54 + admin flag is partial Hand. Only 00-00 may use account administration or curate Vault/Chamber. **Why:** a generic admin flag must not grant full-owner powers.
- 01-54 receives the Hand surface only for the all-seat roster and read-only Deleted/Contracts archives. Restore/purge, Reports/Investigations, Royals, and account operations remain 00-00-only.
