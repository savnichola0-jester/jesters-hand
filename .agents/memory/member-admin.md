...
- Hand roles are identity-pinned: active 00-00 or 01-54 plus the admin flag receives full normal admin authority, including account operations, archives, Reports, Investigations, contracts, admin cards, Deal, and SUITS. Royal awarding is the explicit exception and remains exact-00-00. Self-targeting and permanent transfer/wipe of an admin account remain blocked.
- Vault/Chamber document upload, replacement, and retained-file deletion remain exact-00-00 keeper operations. **Why:** the second Hand has full administrative parity everywhere else, but the document keeper boundary is deliberately narrower than generic admin access.
